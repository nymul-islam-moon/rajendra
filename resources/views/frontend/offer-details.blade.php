    ...
    <section class="rooms-page section-padding" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="section-title">Offer Package Name </div>
                    <h6>5000 BDT</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="butn-dark mt-15 mb-30"> <a href="rooms2.html"><span>Book Now</span></a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 offset-md-1">
                    ...
                    <div class="item">
                        <img class="offer-img-border" src="img/offers/11.jpg" alt=""> </div> 
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-30 mt-30">
                        ...
                        <div class="reservations mb-30">
                            ...
                            <div class="text">
                                <p class="color-1">Reservation</p> <a class="color-1" href="tel:+8801715-431714">+880
                                    1715-431714</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="footer-column footer-about">
                            ...
                            <div class="footer-about-social-list">
                                <a href="https://www.facebook.com/rajendraresort?mibextid=LQQJ4d"><i
